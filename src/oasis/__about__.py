...
Key Components:
- oasis.models: Pure domain entities (Asset, Interval, Candle)
- oasis.engine: The core WebSocket communication framework
- oasis.adapters: Transformation layer for Pandas and data science suites
"""